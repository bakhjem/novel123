      ...
      <div>
        ...
        <div className="phan-trang">
          {this.props.newupdate.page !== this.props.newupdate.totalpage &&
            <a href={'/updates/page/' + (parseInt(this.props.newupdate.page) + 1)} class="quantitychapter">Next page</a>
          }
          {this.props.newupdate.page !== '1' &&
            <a href={'/updates/page/' + (parseInt(this.props.newupdate.page) - 1)} class="page">Pre page</a>
          }
        </div>
      </div>
    );
