  ...
  render() {
    ...
    return (
      <div>
        ...
        <a href={'/genres/'+this.props.genresdetail.idgenres+'/page/'+(parseInt(this.props.genresdetail.page)+1)} class="quantitychapter">Next page</a>
        }
        {this.props.genresdetail.page !== '1' &&
        <a href={'/genres/'+this.props.genresdetail.idgenres+'/page/'+(parseInt(this.props.genresdetail.page)-1)} class="page">Pre page</a>
        }
        </div>
      </div>
    );
